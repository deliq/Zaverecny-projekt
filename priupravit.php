...
<body style="background-image: url('loginpozadie.jpg');">>
    <br />
    <form class="vymazat_div" action="/priuprav_id.php" method="post">
    <label class="id_vymazat_txt"> ID na upravenie: </label>
    <input type="number" name="id_zmenit" class="id_vymazat"><br>
